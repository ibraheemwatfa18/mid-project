 ...
 *
 * <p>used as the payload of both {@code BOOK_ORDER} and {@code JOIN_WAITING_LIST} messages.
 */
public class BookingRequest implements Serializable {
    ...
    private final String orderType;   // "INDIVIDUAL" | "FAMILY" | "GROUP"
     ...
     * @param orderType   {@code "INDIVIDUAL"}, {@code "FAMILY"}, or {@code "GROUP"}
    ...
    /** @return the park name (display use only; not persisted separately) */
    ...
    /** @return the order type: {@code "INDIVIDUAL"}, {@code "FAMILY"}, or {@code "GROUP"} */
