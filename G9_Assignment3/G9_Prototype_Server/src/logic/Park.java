 ...
 *
 * <p>sent in response to {@code GET_PARKS} and used for park selection, capacity checking,
 * and price calculation. an instance with {@code id = 0} / name {@code "All Parks"}
 * serves as a sentinel in report filter combo-boxes.
 */
