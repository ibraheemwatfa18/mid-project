 ...
 *
 * <p>the server finds the most recent active check-in for this visitor at this park
 * today and stamps the current time as {@code exit_time}.
 *
 * <p>sent as the payload of {@code REGISTER_EXIT}.
 */
