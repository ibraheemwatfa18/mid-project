 ...
 *
 * <p>sent as the payload of {@code ENTRY_APPROVED} on success, or {@code ENTRY_DENIED}
 * carries the error string instead. displayed in the entry-result card of
 * {@link gui.EntryControlController}.
 */
