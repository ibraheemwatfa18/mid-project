 ...
 *
 * <p>carries personal info plus optional subscriber details. the server validates,
 * inserts into {@code visitors} (and optionally {@code subscribers}), and
 * responds with a {@link RegisterResult}.
 *
 * <p>payload of {@code REGISTER_VISITOR}.
 */
public class RegisterRequest implements Serializable {
     ...
     * @param subscriber {@code true} if also joining the Family Member Club
